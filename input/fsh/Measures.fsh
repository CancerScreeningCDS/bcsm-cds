...
Instance: ScreeningTestIncompleteMeasure
InstanceOf: Measure
Title: "Screening Test Incomplete Measure"
Usage: #definition

* insert CommonMetadata
* url = "http://cancerscreeningcds.github.io/bcsm-cds/Measure/ScreeningTestIncompleteMeasure"
* version = "1.0.0"
* name = "ScreeningTestIncompleteMeasure"
* status = #active
* description = """
